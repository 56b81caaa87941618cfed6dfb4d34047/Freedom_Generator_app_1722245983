...
Vue.component("simple_header_component_1722245984", {
    template: `
    <header id="header-section" style="height: 110px" class="w-full">
        <nav id="nav-bar" class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a id="logo-link" href="#" class="flex items-center">
                    ...
                    <span id="app-name" class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Liberty Hub</span>
                </a>
